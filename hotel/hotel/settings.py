...
SECRET_KEY = 'django-insecure-l_$9mp8vk5@g#$_nbc-churpa6_@ql2z0eexc9d3x$_(8z8o@&'
...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles','firstpage'
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'firstpage.context_processors.new_updates_processor',
            ],
        },
    },
]
